        ...
        <div class="con-top-bg">
            <div class="con-top">
                <div class="top-left">
                    ...
                    <a href="register.jsp" class="re-url">免费注册</a>
                </div>
                <div class="top-right">
            ...
            <div class="hot-block">
                ...
                <%
					...
					try{
						...
						ResultSet rs = stmt.executeQuery("select id,price,img,describle from goods order by havesold desc");
						for(int i=0;i<9;i++){
							if(rs.next()){
								String id = rs.getString(1);
								String price = rs.getString(2);
								String img = rs.getString(3);
								String describle = rs.getString(4);
								...
								out.println("<span class='item-de'>"+ describle +"</span>");
								out.println("<span class='item-price'>"+ price +"</span>");
								out.println("</div></a>");
							}else{
								break;
							}
